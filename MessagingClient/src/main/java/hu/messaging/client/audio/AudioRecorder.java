package hu.messaging.client.audio;
...
public class AudioRecorder {
	...
	private static final String tempWavfileName = "c:\\diploma\\testing\\testFile";
	...
	public static void main(String[] args) {
		...
		if (sm_bDebug) {
			out("AudioRecorder.main(): output filename: " + tempWavfileName); 
		}

		File outputFile = new File(tempWavfileName);
		...
		*/
		...
		if (strExtension == null)
		{
			...
			*/
			int	nDotPosition = tempWavfileName.lastIndexOf('.');
			if (nDotPosition != -1)
			{
				strExtension = tempWavfileName.substring(nDotPosition + 1);
			}
		}
		if (strExtension != null)
		{
